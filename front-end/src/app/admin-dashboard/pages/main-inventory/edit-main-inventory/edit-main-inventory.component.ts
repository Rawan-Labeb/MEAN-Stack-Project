...
@Component({
  selector: 'app-edit-main-inventory',
  imports: [FormsModule, CommonModule, UploadComponent],
  templateUrl: './edit-main-inventory.component.html',
  styleUrl: './edit-main-inventory.component.css'
})
export class EditMainInventoryComponent {
