...
@Component({
  selector: 'app-add-main-inventory',
  imports: [FormsModule,CommonModule,UploadComponent],
  templateUrl: './add-main-inventory.component.html',
  styleUrl: './add-main-inventory.component.css'
})
export class AddMainInventoryComponent {
  @Input() show = false;
    @Input() userData: User ={
        _id: '',
        role: 'customer',
